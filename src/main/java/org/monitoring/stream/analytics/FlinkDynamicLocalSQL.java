...
public class FlinkDynamicLocalSQL {
    private final static Logger LOGGER = LoggerFactory.getLogger(FlinkDynamicLocalSQL.class);
	...
	tableEnv.connect(new Kafka().version("0.10").topic("testin").properties(kConsumer).startFromLatest())

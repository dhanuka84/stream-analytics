...
public class Event implements Serializable {
	...
	@JsonProperty("PassengerName")
	public void setPassengerName(String providerInfo) {
	...
	public String toString() {
		return "Event [DriverID=" + DriverID + ", HireID=" + HireID + ", CorrelationID=" + CorrelationID
				+ ", providerInfo=" + providerInfo + ", eventType=" + "]";
	}
